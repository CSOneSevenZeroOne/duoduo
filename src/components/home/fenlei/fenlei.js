                        ...
                        {((arr) => {
                            return arr.map((e, i) => {
                                return <li key={i}>
                                    ...
                                    <Link to={"/index/info?book_id="+e.list[0].id} className="top">
                                    ...
                                    <ol>
                                        {(function (arr) {
                                            ...
                                            for (var i = 1; i < arr.length; i++) {
                                                list.push(<li key={i}><Link to="#">[{arr[i].class.split("：")[1]}]</Link> <Link to={"/index/info?book_id="+arr[i].id}><span>{arr[i].title}</span></Link></li>)
                                            }
                                            return list
                                        })(e.list)}
                                    </ol>
